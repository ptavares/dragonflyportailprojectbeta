...
public class ProjectManager {
	...
	public boolean addQuestionResponse(String proj, String question, String response) throws DragonflyBddException {
		...
		try {
			...
			FAQ faq = (FAQ) session.get(FAQ.class,project.getFaq().getFaq_id());
			
			Collection<QuestionResponse> collection = faq.getQuestionResponse();
			if(collection == null ){
				faq.setQuestionResponse(new LinkedList<QuestionResponse>());
				collection = faq.getQuestionResponse();
			}
	...
	public boolean removeQuestionResponse(String name, String qr_id) throws DragonflyBddException {
		...
		try{
			...
			FAQ faq = project.getFaq();
			Collection<QuestionResponse> coll =faq.getQuestionResponse();
	...
	public Collection<QuestionResponse> getProjectFAQ(String project) throws DragonflyBddException {
		...
		try{
			...
			Collection<QuestionResponse> list = faq.getQuestionResponse();
			if(list == null)
				return Collections.unmodifiableCollection(new ArrayList<QuestionResponse>());
