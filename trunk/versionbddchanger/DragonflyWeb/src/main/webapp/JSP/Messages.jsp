...
<div id="topMenu" dojoType="ContentPane" class="header" 
	 ...
	 <s:a formId="messages" targets="rightcolumn">Delete</s:a>
...
<s:form id="messages"  action="supprimerMessage" method="post">
<table width=80%>
<tr class="header"><td>Sender</td><td>Subject</td><td colspan="3">Date</td></tr>
<%int i=0;%>
...
<%String name="ids["+i+"]"; %>
	<tr>
		...
		<td>
		<input type="checkbox" name="<%=name%>" value="<s:property  value="id"/>"/>
		</td>		
	</tr>
	<%i++;%>
</s:iterator>
