...
<s:a href="%{down}" theme="xhtml"><img src="img/download.jpg" height="18" border="0"/></s:a>
</td>
<td width="50" class="suppress">
<s:url id="del" action="FileDelete">
<s:param name="fileDel" value="path"/>
</s:url>
<s:a href="%{del}" targets="fileTabs"> <img src="img/project/delete.jpg" height="18" border="0"/> </s:a>
</td>
<td width="50">
<s:url id="valide" action="FileValide">
<s:param name="file" value="fliename"/>
</s:url>
<s:a href="%{valide}" targets="fileTabs"> <img src="img/yes.jpg" height="18" border="0"/> </s:a>
</td>
</tr>
</s:iterator>


<s:iterator  value="nameListR">
<tr>
<td>
<s:property value="fliename"/>
</td>
