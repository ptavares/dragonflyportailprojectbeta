...
public class ChangeEmail extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		//TODO : Probleme avec le changement de mail. C'est peut être parce-que le mail constitue la cl?
		//primaire de la table. En tout cas, il n'arrive pas ? changer le mail. Soit remplacer par un système
