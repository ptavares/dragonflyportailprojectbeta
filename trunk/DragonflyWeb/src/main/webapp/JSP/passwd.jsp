...
<s:submit targets="rightcolumn" onclick="cryptePasswords2(new Array('change.oldpass','change.newpass','change.confirmpass'));" showLoadingText="false"  notifyTopics="loginLoading,loading,refresh"></s:submit>
</s:form>
